...
export const team: Practitioner[] = [
  ...
  },
  {
    ...
    bio: 'Noushin Nouri is a Registered Physiotherapist with over 11 years of experience helping patients recover from injuries, improve mobility, and return to the activities they enjoy. She began her physiotherapy career in Iran after graduating in 2011 and continued practicing in orthopedic and rehabilitation settings before relocating to Canada and becoming fully licensed as a physiotherapist.\n\nHer clinical focus includes musculoskeletal conditions, sports injuries, post-operative rehabilitation, and chronic pain management. Noushin believes in creating individualized treatment plans based on each patient’s specific needs and goals. Her approach combines manual therapy, active rehabilitation, and evidence-informed techniques to support long-term recovery and functional improvement.\n\nShe values building strong connections with her patients and empowering them through education and movement-based therapy. Noushin is committed to providing a supportive and positive environment where patients feel confident throughout their rehabilitation journey.\n\nOutside the clinic, she enjoys travelling, camping, spending time outdoors, and exploring nature with family and friends. She provides care in both English and Farsi.',
    registration: 'Registered with the College of Physical Therapists of British Columbia',
  },
  {
    slug: 'asal-akbari',
    ...
    bio: 'Asal holds bachelor’s and master’s degrees in general psychology from Arak University in Iran. She was enrolled in a PhD in psychology when she decided to move to Canada a few years ago.\n\nShe is a member of the British Columbia Association of Clinical Counsellors and utilizes various approaches including Cognitive Behavioral Therapy (CBT), Integrated Psychotherapy, Acceptance and Commitment Therapy (ACT), and Mindfulness.\n\nShe has extensive experience in areas such as PTSD, depression, ADHD, parenting, and couples and individual counselling.',
  },
  {
  ...
  },
  {
    ...
    bio: 'Kambiz is a highly skilled Registered Acupuncturist, renowned for his expertise in acupuncture, moxibustion, and cupping. With a deep commitment to alternative medicine, he earned a Certificate in Acupuncture, which has become the cornerstone of his practice. His approach centers on holistic care, integrating traditional acupuncture techniques to address a wide range of health issues, particularly in pain management.\n\nHis medical journey began with a Doctor of Medicine degree earned in 1989 from Iran, followed by a specialization in Physical Medicine and Rehabilitation in 1997. His extensive experience spans over three decades, during which he has served in various capacities within private practices and hospital environments, including as Chief of the Rehabilitation Ward.\n\nIn addition to his acupuncture expertise, he is an instructor of Anatomy and Physiology at Central College of Acupuncture in New Westminster, BC. In his previous role, he performed Nerve Conduction Studies and Electromyography on over 40,000 patients, with a particular focus on musculoskeletal pain.\n\nHe is dedicated to offering comprehensive patient care through the best practices of alternative medicine with the help of his vast knowledge of Western medicine.',
  },
  {
    slug: 'sirus-vakilian',
