...
export const team: Practitioner[] = [
  ...
  },
  {
    ...
    name: 'Mehdi Tafreshi',
    role: 'Osteopath',
    credentials: 'Osteopath (D.O.M.P.), Physiotherapist, FIFA Dip. Sports Medicine',
    img: '/images/existing/team-mehdi-tafreshi.jpg',
    languages: ['English', 'Farsi'],
    focus: ['Whole-body manual therapy', 'Chronic stiffness', 'Postural pain'],
    bio: 'Mehdi treats the body as one connected system rather than a set of separate joints. A licensed physiotherapist since 2001 and an osteopath since 2018, with a FIFA Diploma in Sports Medicine, he draws on craniosacral therapy, visceral manipulation, and dry needling for stubborn, multi-area pain that a single-region approach has not resolved. Twenty years in, he is who patients see when nothing else has worked.',
  },
  {
    slug: 'noushin-nouri',
    name: 'Noushin Nouri',
  ...
  },
  {
    ...
    bio: 'Ali treats across sports, musculoskeletal, and neurological cases, with a particular interest in returning athletes to performance. With more than a decade of practice, he blends manual therapy with progressive exercise, building rehab that respects the timeline of the sport, not just the injury.',
    registration: 'Registered with the College of Physical Therapists of British Columbia',
  },
  {
    slug: 'asal',
  ...
  },
  {
    ...
    bio: 'Ramin treats chronic pain, stress, and sleep through acupuncture, drawing on trigger-point and injection techniques and Tui na massage. With a science background behind him, he most often works as one part of a broader plan the rest of the team contributes to.',
  },
  {
    slug: 'azam-hosseini',
    name: 'Dr. Azam Hosseini',
    role: 'Psychiatry & Counselling',
    credentials: 'Psychiatrist, Registered Therapeutic Counsellor (RTC), Clinical Director',
    languages: ['English', 'Farsi'],
    focus: ['Psychiatric assessment', 'Mental health', 'Recovery and wellbeing'],
    bio: 'Dr. Hosseini is a psychiatrist and the clinic’s clinical director. Trained at Mashhad University of Medical Sciences, the practice spans psychiatric assessment and psychotherapy, including CBT, DBT, and schema therapy, for patients whose recovery has a mental-health dimension. The care is culturally attuned and available in Farsi and English.',
  },
  {
    slug: 'melina-raad',
    name: 'Melina Raad',
    role: 'Office Manager',
    credentials: 'Office Manager, Certified Medical Assistant',
    img: '/images/existing/team-Melina-Raad.jpg',
    languages: ['English', 'Farsi'],
    focus: ['Booking and scheduling', 'Insurance and billing', 'Patient coordination'],
    bio: 'Melina runs the front of the clinic, from booking and scheduling to direct billing. With Azalea since 2012, she handles the insurance side, ICBC, WorkSafeBC, and extended health, so you do not have to. She is usually the first person you speak with.',
  },
]
